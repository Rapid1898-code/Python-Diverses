...
def hash_password(password):
    ...
    :param password:    Provided password which get salted and hashed
    :return:            Salted an hashed password for storing eg. in a db
    """
...
def verify_password(stored_password, provided_password):
    ...
    :param stored_password:    The salted and hashed password eg. from the db
    :param provided_password:  The pw provided by the user
    :return:                   True => passowrd is correct, False => password is wrong
    """
